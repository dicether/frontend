    ...
    render() {
        ...
        return (
            <div className={Style.gameFooter}>
                <ButtonToolbar>
                    <IconButton color="secondary" id="settingsPopover" icon="cog" onClick={this.toggleSettingsPopover}/>
                    <Popover target="settingsPopover" placement="top" isOpen={showSettingsPopover} toggle={this.toggleSettingsPopover}>
                        <ul className={Style.settings}>
                            <li className={Style.settings__setting}><span className={Style.settings__key}>Expert View</span>
                                <Switch size="sm" enabled={showExpertView} onToggle={onToggleExpertView}/>
                            </li>
                              <li className={Style.settings__setting}><span className={Style.settings__key}>Sound</span>
