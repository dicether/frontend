...
const entries = [
    {
        ...
        text:
            "We are even more than Provably Fair." +
            " You can not only check your results or the results of all other users," +
    ...
    },
    {
        ...
        heading: "Fast",
        text:
            "We are using state channels You only need to wait a little bit to create a game session." +
    ...
    },
    {
        ...
        heading: "Anonymous",
        text:
            "Absolutely no details are required. You select a username, sign in with metamask or similar." +
