...
export const changeFriends = ca((friends : Array<Friend>) => {
...
export const changeReceivedFriendRequests = ca((receivedFriendRequests : Array<FriendRequest>) => {
...
export const changeSentFriendRequests = ca((sentFriendRequests : Array<FriendRequest>) => {
