...
const Style = require('./UserType.scss');
    ...
    if (userType === 'ADM') {
        return (
            <span>
                <span ref={t => {
                    target = t
                }} className={Style.userType + ' ' + Style.userType_adm}>A</span>
        ...
        return (
            <span>
                <span ref={t => {target = t}} className={Style.userType + ' ' + Style.userType_dev}>D</span>
        ...
        return (
            <span>
                <span ref={t => {target = t}} className={Style.userType + ' ' + Style.userType_mod}>M</span>
        ...
        return (
            <span>
                <span ref={t => {target = t}} className={Style.userType + ' ' + Style.userType_bot}>B</span>
